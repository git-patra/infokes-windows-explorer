...
CREATE INDEX "folders_path_gist_idx" ON "folders" USING GIST ("path");--> statement-breakpoint
CREATE INDEX "folders_name_trgm_idx" ON "folders" USING GIN ("name" gin_trgm_ops);--> statement-breakpoint
